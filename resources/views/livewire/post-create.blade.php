<div>
    <div class="container mx-auto px-4">
        <h1 class="text-4xl mt-6 tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">Minak Post</h1>
        <p class="text-lg mt-2 text-gray-600">Ntene Tok Mek nulis kanak.</p>
